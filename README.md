...
GRANT CONNECT ON DATABASE "STUDENTSNEW" TO app_connector;
...
GRANT CONNECT ON DATABASE "STUDENTSNEW" TO GlFr_junior;
...
GRANT ALL PRIVILEGES ON DATABASE "STUDENTSNEW" TO GlFr_admin;
